            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        ...
                        <img class="h-24 w-auto" src="{{ asset('storage/logo/sjmc.png')}}" alt="sjmc logo">
                        </div>
                        @if (Route::has('login'))
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-1 lg:gap-8">
                            {{-- <a
                                ...
                                id="docs-card"
                                class=" overflow-hidden     focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10"
                            > --}}
                                {{-- <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch"> --}}
                                    {{-- <img class=" w-full"src="{{ asset('storage/logo/sjmc.png')}}" alt="sjmc logo"> --}}
                                    {{-- <img
