...
<button
    {{
        $attributes->class([
            ...
            'border-neutral-200 text-neutral-800 hover:text-neutral-500 focus:border-blue-500 active:text-neutral-800 dark:border-neutral-700 dark:focus:border-blue-600 dark:text-neutral-300 dark:hover:text-white dark:focus:border-blue-600 dark:active:text-white' => ! $active,
