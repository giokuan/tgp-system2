@if($table['columns']->isNotEmpty())
    <x-livewire-table::dropdown label="{{ __('Columns') }}">
        ...
        <span
            class="flex gap-2 px-3 py-2 font-bold text-xs uppercase border-b border-neutral-200 backdrop-blur-md bg-white/30 text-neutral-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-300">
