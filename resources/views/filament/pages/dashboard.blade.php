<x-filament-panels::page>
    <div class="flex items-center gap-x-3">
        <div  class="flex-1 ">
            <p class=" font-bold text-lg">Important Reminder for Moderators</p><br>
            ...
            <span class="font-bold ">Policy Note:</span> Unauthorized sharing, editing, or misuse of sensitive data is strictly 
