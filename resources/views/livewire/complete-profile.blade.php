            ...
            <div class="p-2">
                <div class="flex flex-col gap-2 xl:flex-row">
                    ...
                    <input type="text" wire:model="first_name" name="first_name"
                        class="block w-full px-4  mt-1 bg-white border rounded-md shadow-sm border-slate-300 placeholder-slate-400 placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm"
                ...
                <div class="my-6">
                    <textarea type="text" wire:model="address" id="address" cols="30" rows="4" name="address"
                        class="w-full h-20 p-5 mb-10 text-gray-300 border rounded-md resize-none border-slate-300 placeholder-slate-400 placeholder:text-gray-500"
