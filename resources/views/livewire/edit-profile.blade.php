<div class="md:mx-36">
    ...
    <form wire:submit="updateProfile" method="POST" enctype="multipart/form-data">
        <div class="mt-4 border-2 border-yellow-500 rounded-lg xl:mx-14">
            <div class="mt-10 font-bold text-yellow-500 text-center">Update Profile</div>
            ...
            <div class="p-2">
                ...
                <div class="my-6">
                    <textarea type="text" wire:model="address" id="address" cols="30" rows="4" name="address"
                        class="w-full h-20 p-5  text-gray-500 border rounded-md resize-none border-slate-300 placeholder-slate-400 placeholder:text-gray-500"
